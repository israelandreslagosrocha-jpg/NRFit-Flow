  ...
  switch (templateId) {
    ...
    case 'flow_trial_welcome':
      return {
        ...
        `,
        text: `¡Hola, ${payload.studentName || 'Alumna'}! Tu prueba de 7 días ya está activa ($0 CLP hoy). Puedes cancelar en 1 clic desde tu perfil.`,
      };
    ...
    case 'payment_success':
      return {
        ...
        `,
        text: `Hola, ${payload.studentName || 'Alumna'}. Pago confirmado. Tu acceso continúa activo.`,
      };
      ...
      return {
        ...
        html: `
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1f2937;">
            ...
            <p>Hola, ${payload.studentName || 'Alumna'}. Tu renovación ha sido cancelada.</p>
            <p><strong>Confirmación financiera:</strong> Al cancelar durante el período de prueba, no se realizará ningún cobro posterior ($0 CLP cobrados en total). Mantendrás tu acceso hasta el final de tu semana de prueba.</p>
            <p>Esperamos volver a verte pronto en el Team.</p>
            <p style="color: #64748b; font-size: 13px;">Equipo Naty Entrenadora • ${supportEmail}</p>
          </div>
        `,
        text: `Hola, ${payload.studentName || 'Alumna'}. Tu renovación de prueba ha sido cancelada sin cobro ($0 CLP cobrados en total).`,
      };
      ...
      return {
        ...
        html: `
          <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #1f2937;">
            ...
            <p>Tu acceso al portal continuará vigente hasta el final del ciclo pagado actual (${payload.accessUntil || payload.periodEnd || 'fecha de término'}).</p>
            <p style="color: #64748b; font-size: 13px;">Equipo Naty Entrenadora • ${supportEmail}</p>
          </div>
        `,
